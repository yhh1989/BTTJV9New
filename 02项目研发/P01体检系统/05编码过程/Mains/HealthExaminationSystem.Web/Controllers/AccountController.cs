...
using Sw.Hospital.HealthExaminationSystem.Application.Sessions;
...
using Sw.Hospital.HealthExaminationSystem.Web.Controllers.Results;
using Sw.Hospital.HealthExaminationSystem.Web.Models;
using Sw.Hospital.HealthExaminationSystem.Web.Models.Account;
        ...
        public virtual async Task<ActionResult> Register(RegisterViewModel model)
        {
            try
            {
                ...
                if (model.IsExternalLogin)
                {
                    ...
                    model.Password = global::Sw.Hospital.HealthExaminationSystem.Core.Authorization.Users.User.CreateRandomPassword();
