...
{
    public partial class SuspectedChart :UserBaseForm
    {
        private readonly IOccConclusionSuspectedAppService _OccConclusionSuspectedAppService;
        private List<OccConclusionSuspectedShow> occSuspected;

        public SuspectedChart()
        {
            InitializeComponent();
            _OccConclusionSuspectedAppService = new OccConclusionSuspectedAppService();
        }
        public SuspectedChart(List<OccConclusionSuspectedShow> input) : this()
        {
            occSuspected = input;
        }
        private void SuspectedChart_Load(object sender, EventArgs e)
        {
            try
            {
