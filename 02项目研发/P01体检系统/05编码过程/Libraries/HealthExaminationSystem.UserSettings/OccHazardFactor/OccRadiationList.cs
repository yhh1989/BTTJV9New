...
{
    public partial class OccRadiationList : UserBaseForm
   ...
   {    //public CreateOrUpdateHazardFactorDto _Model { get; private set; }
        ...
        private void InitializeData()
        {
            ...
            RadiationDto show = new RadiationDto();
            show.IsActive = 3;
            var data = _OccHazardFactorAppService.ShowRadiation(show);
        ...
        {
            //Add();
            using (var frm = new OccRadiationEdit())
            {
        ...
        private void simpleButton3_Click(object sender, EventArgs e)
        {
            ...
            var old = gridView1.GetFocusedRow() as RadiationDto;
            if (id == null)
            {
            ...
            if (id != null)
                using (var frm = new OccRadiationEdit((Guid)id,old))
                {
                    if (frm.ShowDialog() == DialogResult.OK)
                    {
        ...
        private void simpleButton1_Click(object sender, EventArgs e)
        {
            ...
            {
                indexls.Clear();
                var result = _OccHazardFactorAppService.ShowRadiation(show);
        ...
        private void simpleButton4_Click(object sender, EventArgs e)
        {
                ...
                DialogResult.Yes)
            {
                try
                {
                    ...
                    var dto = gridControl1.GetFocusedRowDto<RadiationDto>();
                    AutoLoading(() =>
                    {
                        _OccHazardFactorAppService.DelRadiation(new EntityDto<Guid>
                        {
                            Id = (Guid)id
                        });
