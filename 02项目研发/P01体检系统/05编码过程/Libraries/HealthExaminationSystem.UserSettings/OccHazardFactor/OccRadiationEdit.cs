...
{
    public partial class OccRadiationEdit : UserBaseForm
    {
        ...
        private void OccHazardFactorEdit_Load(object sender, EventArgs e)
        {
            ...
            chargeBM.Name = ZYBBasicDictionaryType.Exposure.ToString();
        ...
        public OccRadiationEdit(Guid id, RadiationDto model) : this()
        {
            _id = id;
            _Model = model;
        }
        ...
        private bool Ok()
        {
            ...
            //CAS码
            dto.code = textEdit2.Text.Trim();
            dto.ComCode = textEditcomcode.Text.Trim();
            //是否启用
            ...
            AutoLoading(() =>
            {
                ...
                {
                    dtos = _OccHazardFactorAppService.AddRadiation(dto);
                   
                }
                else
                {
                    dtos = _OccHazardFactorAppService.EditRadiation(dto);
                }
                _Model = dtos;
                res = true;
            });
        ...
        private void LoadData()
        {
            try
            {
                ...
                var data = _OccHazardFactorAppService.GetRadiationDto(new EntityDto<Guid> { Id = _id });
                // 分类名称
                ...
                //cas码
                textEdit2.Text = data.code;
                textEditcomcode.Text = data.ComCode;
