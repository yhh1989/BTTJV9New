...
{
#if !Proxy
    [Abp.AutoMapper.AutoMap(typeof(TjlCustomer), typeof(QueryCustomerDto))]
#endif
    public class SaveCusInfoDto : EntityDto<Guid>
    {
        /// <summary>
        /// 档案号 
        /// </summary>
        ...
        /// 个人/团体
        /// </summary>
        public virtual string personalOrGroup { get; set; }
