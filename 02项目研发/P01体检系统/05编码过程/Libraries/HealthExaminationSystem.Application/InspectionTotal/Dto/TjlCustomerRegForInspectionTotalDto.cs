...
namespace Sw.Hospital.HealthExaminationSystem.Application.InspectionTotal.Dto
{
    ...
    /// </summary>
#if !Proxy
    [Abp.AutoMapper.AutoMap(typeof(TjlCustomerReg), typeof(TjlCustomerRegForInspectionTotalSearchDto))]
#endif
    public class TjlCustomerRegForInspectionTotalDto : EntityDto<Guid>
    {
        /// <summary>
        ...
        ///////// 体检人项目组合
        ///////// </summary>
        //public virtual List<CusTypeGroupStateDto> CustomerItemGroup { get; set; }
...
//        /// </summary>
//        [JsonIgnore]
//        public virtual string NoCheckGroupNames
//        {
//            get
//            {
...
//                    var nocheck = CustomerItemGroup.Where(P => !P.DepartmentBM.Category.Contains("耗材")
//                     && P.CheckState == (int)ProjectIState.Not).Select(p => p.DepartmentName).Distinct().ToList();
//                    return string.Join(",", nocheck);
...
//#endif
        ...
        /// </summary>
        [JsonIgnore]
        public virtual string OccSummSateFormat
        {
            get
            {
                if (!string.IsNullOrWhiteSpace(OccSummSate.ToString()))
                {
                    if (int.TryParse(OccSummSate.ToString(), out var result))
                    {
                        return EnumHelper.GetEnumDesc((SummSate)result);
                    }
                }
