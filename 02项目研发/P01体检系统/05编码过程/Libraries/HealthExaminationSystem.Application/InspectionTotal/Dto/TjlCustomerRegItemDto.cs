...
#endif 
    public class TjlCustomerRegItemDto : EntityDto<Guid>
    {
        /// <summary>
        ...
        /// 科室ID
        /// </summary>
        public virtual CTbmDepartmentDto DepartmentBM { get; set; }
        ...
        /// 体检人检查项目组合id
        /// </summary>
        public virtual TjlCustomerItemGroupDto CustomerItemGroupBM { get; set; }
