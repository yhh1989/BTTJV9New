...
namespace Sw.Hospital.HealthExaminationSystem.Application.CrossTable
{
    ...
    public class CrossTableAppService : MyProjectAppServiceBase, ICrossTableAppService
    {
        ...
        /// <returns></returns>
        [UnitOfWork(false)]
        public List<CustomerRegForCrossTableViewDto> QueryCustomerInfo(PageInputDto<QueryInfoDto> input)
        {
        ...
        /// <returns></returns>
        [UnitOfWork(false)]
        public CrossTableViewDto QueryCustomerIn(QueryInfoDto input)
        {
            var allData = _jlCustomerReg.GetAll().AsNoTracking();
            ...
            if (!string.IsNullOrWhiteSpace(input.CustomerRegNum))
            {
                ...
                result.CustomerReg = allData.MapTo<List<CustomerRegForCrossTableViewDto>>(); 
                return result;
            }
