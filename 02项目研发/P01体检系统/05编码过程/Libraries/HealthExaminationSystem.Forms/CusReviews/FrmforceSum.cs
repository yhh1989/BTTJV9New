...
{
    public partial class FrmforceSum : UserBaseForm
    {
        ...
        public void LoadData()
        {
            AutoLoading(() =>
            {
                ...
                input.SumState = (int)SummSate.Audited;               
                
               input.CheckState = (int)PhysicalEState.Process;
        ...
        {
            if (e.Column.FieldName == "CSEmployeeId")
            {
                long id = 0;
